      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-1.5 rounded-lg text-white text-sm font-semibold disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        <div className="px-6 pt-2 pb-3">
          <textarea
            ...
            className="w-full resize-none text-gray-800 text-base placeholder-gray-400 leading-relaxed bg-transparent focus:outline-none"
            rows={3}
          />
        </div>
        ...
        <div className="px-6 pb-6">
          ...
          {!preview ? (
            <label className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-xl h-56 cursor-pointer hover:border-gray-400 transition">
            ...
            >
              ...
              <button
                onClick={removeImage}
                className="absolute top-2.5 right-2.5 bg-black bg-opacity-60 hover:bg-opacity-80 text-white p-1.5 rounded-full"
              >
                <X size={16} />
              </button>
            </div>
